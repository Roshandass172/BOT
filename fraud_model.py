...
file_path = r"C:\Users\Rosh05\Desktop\bot\fraud_detection_data.csv"
...
def save_models(fraud_model, anomaly_model, scaler, label_encoders):
    ...
    os.makedirs(r'C:\Users\Rosh05\Desktop\bot\models', exist_ok=True)

    # Save models to the specified directory
    joblib.dump(fraud_model, r"C:\Users\Rosh05\Desktop\bot\models\fraud_model.pkl")
    joblib.dump(anomaly_model, r"C:\Users\Rosh05\Desktop\bot\models\anomaly_model.pkl")
    joblib.dump(scaler, r"C:\Users\Rosh05\Desktop\bot\models\scaler.pkl")
    joblib.dump(label_encoders, r"C:\Users\Rosh05\Desktop\bot\models\label_encoders.pkl")
